...
public final class BlackList
{
  ...
  private static BlackList createDefaultInstance()
  {
    ...
    if (localBlackList == null)
      localBlackList = new BlackList(Collections.EMPTY_MAP);
  ...
  private BlackList(Map paramMap)
  {
  ...
  private void setupDefault()
    throws IOException
  {
    String str1 = Config.getUserBlacklistFile();
    ...
    {
      setup(localFile1);
      this.lastModified = localFile1.lastModified();
    }
