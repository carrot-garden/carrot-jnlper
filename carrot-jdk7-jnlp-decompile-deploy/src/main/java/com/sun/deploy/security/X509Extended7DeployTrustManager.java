    ...
    throws CertificateException
  {
    ...
    try
    {
      ...
      catch (CertificateException localCertStore)
      {
        ...
        {
          if ((!Config.getBooleanProperty("deployment.security.https.warning.show")) && (!bool) && (i == 0) && (CertUtils.checkWildcardDomainList(str2, CertUtils.getServername(paramArrayOfX509Certificate[0]))))
          {
          ...
          else
          {
            ...
            j = TrustDeciderDialog.showDialog(paramArrayOfX509Certificate, null, 0, paramArrayOfX509Certificate.length, bool, i, null, new AppInfo(), true, str2);
          }
        }
        else
        {
